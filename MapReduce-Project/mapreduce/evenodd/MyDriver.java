...
public class MyDriver
{
    public static void main(String[] args) throws IOException,ClassNotFoundException, InterruptedException
    {
       ...
       /* Path input_file_loc = new Path("hdfs://localhost:9000/user/jivesh/evenodd.txt/");   //harcoded input location
        ...
        Path input_file_loc = new Path("C:\\Users\\rv00451128\\Desktop\\mylearning\\Project\\sparkcassandraexample\\evenodd.txt");   //harcoded input location
        Path output_dir_loc = new Path("C:\\Users\\rv00451128\\Desktop\\mylearning\\data\\evenodd");       //harcoded output location
