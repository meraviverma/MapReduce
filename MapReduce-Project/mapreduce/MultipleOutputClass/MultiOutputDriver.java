...
public class MultiOutputDriver {
    public static void main(String[] args) throws IOException, ClassNotFoundException,InterruptedException {
        ...
        //Declare Path
        Path inputPath=new Path("C:\\Users\\rv00451128\\Desktop\\mylearning\\Project\\sparkcassandraexample\\mo.txt"); //input file path
        Path outputDir=new Path("C:\\Users\\rv00451128\\Desktop\\mylearning\\data\\multipleoutput\\"); //output directory path
